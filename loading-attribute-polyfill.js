 ...
 */
const lazyload = function (noscriptClass, rootMargin) {
    'use strict';
    ...
    var config = {
        ...
        noscriptClass: noscriptClass || 'loading-lazy',
    };
    ...
    function prepareElements() {
        //
        var lazyLoadAreas = document.querySelectorAll('noscript.' + config.noscriptClass);
...
lazyload('loading-lazy', '256px 0px');
